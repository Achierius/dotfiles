...
vim.keymap.set("n", "gA", ':e %:p:s,.hpp$,.X123X,:s,.cpp$,.hpp,:s,.X123X$,.cpp,<CR>', opts(noremap_s, { desc = "Switch between .hpp/.cpp" }))
vim.keymap.set("n", "<leader>a", ':e %:p:s,.hpp$,.X123X,:s,.cpp$,.hpp,:s,.X123X$,.cpp,<CR>', opts(noremap_s, { desc = "Switch between .hpp/.cpp" }))
